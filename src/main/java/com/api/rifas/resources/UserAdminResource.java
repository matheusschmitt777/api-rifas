...
import com.api.rifas.servies.UserAdminService;
...
public class UserAdminResource {
	...
	public ResponseEntity<UserAdmin> findById(@PathVariable Long id) {
		UserAdmin obj = service.findById(id);
		return ResponseEntity.ok().body(obj);
	}
	
	@PostMapping
	public ResponseEntity<UserAdmin> insert(@RequestBody UserAdmin obj) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<UserAdmin> update(@PathVariable Long id, @RequestBody UserAdmin obj) {
