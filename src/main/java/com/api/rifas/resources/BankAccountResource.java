...
import com.api.rifas.servies.BankAccountService;
...
public class BankAccountResource {
	...
	public ResponseEntity<BankAccount> findById(@PathVariable Long id) {
		BankAccount obj = service.findById(id);
		return ResponseEntity.ok().body(obj);
	}
	
	@PostMapping
	public ResponseEntity<BankAccount> insert(@RequestBody BankAccount obj) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<BankAccount> update(@PathVariable Long id, @RequestBody BankAccount obj) {
